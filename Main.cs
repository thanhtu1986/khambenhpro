...
namespace KhamBenhPro
{
    public partial class Main : Form
    {
        ...
        private void cấuHìnhThuốcToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (checkTab("Cấu hình thuốc") == false)
            {
                TabItem tab = TabCtrl_main.CreateTab("Cấu hình thuốc");

                KhamBenh.Thuoc frm01 = new KhamBenh.Thuoc();
                frm01.Dock = DockStyle.Fill;
                frm01.FormBorderStyle = FormBorderStyle.None;
                frm01.TopLevel = false;
                tab.AttachedControl.Controls.Add(frm01);
        ...
        private void cấuHìnhCLSToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (checkTab("Cấu hình CLS") == false)
            {
                TabItem tab = TabCtrl_main.CreateTab("Cấu hình CLS");

                KhamBenh.SinhHieu frm01 = new KhamBenh.SinhHieu();
                frm01.Dock = DockStyle.Fill;
                frm01.FormBorderStyle = FormBorderStyle.None;
                frm01.TopLevel = false;
                tab.AttachedControl.Controls.Add(frm01);
