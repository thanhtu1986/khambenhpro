...
namespace KhamBenhPro
{
    public partial class PhieuHen : Form
    {
        ...
        private void PhieuHen_Load(object sender, EventArgs e)
        {
            ...
            KhamBenhPro.rptPhieuHen crystalReport = new KhamBenhPro.rptPhieuHen();
            #region ma vach
            ...
            string ThanTienDV = dtmavach.Rows[0]["ThanhTienDV"].ToString();
           ...
           // crystalReport.SetParameterValue("TenNhom", TenNhom);
            ...
            crystalReport.SetParameterValue("ThanhTienDV", ThanTienDV);
